export async function runGrok(page, prompt, ctx){
  const url = ctx.chatUrl || "https://grok.com/";
  ...
  const sendBtn = page.locator('button:has-text("Send"), button[aria-label*="Send"], button[title*="Send"]');
